    ...
    <div className="flex h-screen bg-slate-50/50 dark:bg-slate-950/50">
      <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col">
        <div className="p-6">
          ...
          <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Admin Console</span>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive 
                    ? "bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 font-medium shadow-sm" 
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-8 relative">
          <div className="absolute top-0 left-0 w-full h-[300px] bg-gradient-to-b from-purple-50/50 to-transparent dark:from-purple-900/10 -z-10 pointer-events-none" />
          <Outlet />
        </div>
      </main>
    </div>
